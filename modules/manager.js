...
manager.addAnswer('en', 'greetings.hello', "I'm doing well, thanks for asking!");
...
manager.addDocument('en', 'Tell me your name', 'tell.myself');
//
manager.addAnswer('en', 'tell.myself', 'I am a neural Object language model my Name is Ai-mrk');
manager.addAnswer('en', 'tell.myself', 'My name Ai-mrk');
manager.addAnswer('en', 'tell.myself', "i'm batman, just kidding i am your Ai assistant Ai-mrk");
manager.addAnswer('en', 'tell.myself', "my name is Ai-mrk");
manager.addAnswer('en', 'telldo.myself', "i can build markdown for you, just give me the topic you want me to create markdown");
...
manager.addAnswer('en', 'entertainment.joke', 'Why did the computer catch a cold? It had too many bytes!');
manager.addAnswer('en', "entertainment.joke', 'What did one wall say to the other wall? I'll meet you at the corner!");
manager.addAnswer('en', "weather.inquiry', 'I'm sorry, I don't have access to real-time weather information.");
manager.addAnswer('en', 'weather.inquiry', 'You can check the weather using a weather app or website.');
manager.addAnswer('en', 'weather.inquiry', 'You can check the weather using a weather app or website.');
manager.addAnswer('en', 'education.math', 'Of course, I can help you with math. What kind of math problem do you need assistance with?');
